...
- Fill ICC placeholders after analyses (κ filled from `grading/agreement_stats.md`; effect sizes filled from `stats/table3_effect_sizes.md`).
...
- ICC primary: 3-observer multi-rater ICC(2,1) on n≈20; multilevel VC ICC optional; intra-observer S1/S2 only if data allow.
