...
from utils.batch_input_filter import filter_mnv_files_for_roi_selection
...
def export_mnv_results_to_csv() -> tuple:
    ...
    buf_bytes = build_csv_bytes_from_imagej_rows(rows, meta)
    ...
    return buf_bytes, suggested_name
