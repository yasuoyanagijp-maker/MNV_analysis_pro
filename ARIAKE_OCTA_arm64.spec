...
# ARIAKE_OCTA_arm64.spec — Apple Silicon (M1/M2/M3) 用
# M1 Mac でビルド成功済み。arm64 ネイティブ用。
import os
import sys
...
for pkg in ['flet', 'flet_desktop', 'fastapi', 'uvicorn', 'multipart', 'cv2', 'skimage', 'networkx', 'shapely', 'imageio', 'imagecodecs', 'matplotlib']:
