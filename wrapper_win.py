...
def _plan1_enabled() -> bool:
    """Keep in sync with src.utils.runtime_threads.plan1_requested (opt-in)."""
...
def _apply_plan1_env_early() -> bool:
    ...
    Cannot import src.utils.runtime_threads yet; keep setdefault behavior in
    sync with apply_plan1_env so user-set OMP_NUM_THREADS etc. are preserved.
    """
